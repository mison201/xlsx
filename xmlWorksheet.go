...
func newXlsxWorksheet(s *Sheet) (worksheet *xlsxWorksheet) {
	worksheet = &xlsxWorksheet{}
	worksheet.SheetPr.FilterMode = false
	worksheet.SheetPr.PageSetUpPr = make([]xlsxPageSetUpPr, 1)
	worksheet.SheetPr.PageSetUpPr[0] = xlsxPageSetUpPr{FitToPage: s.ConfigPrinter.FitToPage}
	...
	worksheet.PrintOptions.HorizontalCentered = s.ConfigPrinter.HorizontalCentered
	worksheet.PrintOptions.VerticalCentered = s.ConfigPrinter.VerticalCentered
	...
	worksheet.PageMargins.Left = s.ConfigPrinter.MarginsLeft
	worksheet.PageMargins.Right = s.ConfigPrinter.MarginsRight
	worksheet.PageMargins.Top = s.ConfigPrinter.MarginsTop
	worksheet.PageMargins.Bottom = s.ConfigPrinter.MarginsBottom
	worksheet.PageMargins.Header = s.ConfigPrinter.MarginsHeader
	worksheet.PageMargins.Footer = s.ConfigPrinter.MarginsFooter
	worksheet.PageSetUp.PaperSize = "9"
	if s.ConfigPrinter.PaperSize != "" {
		worksheet.PageSetUp.PaperSize = s.ConfigPrinter.PaperSize
	}
	worksheet.HeaderFooter.DifferentFirst = s.ConfigPrinter.DifferentFirst
	worksheet.HeaderFooter.DifferentOddEven = s.ConfigPrinter.DifferentOddEven
	worksheet.PageSetUp.Scale = 100
	worksheet.PageSetUp.FirstPageNumber = 1
	worksheet.PageSetUp.FitToWidth = s.ConfigPrinter.FitToWidth
	worksheet.PageSetUp.FitToHeight = s.ConfigPrinter.FitToHeight
	worksheet.PageSetUp.PageOrder = "downThenOver"
	worksheet.PageSetUp.Orientation = s.ConfigPrinter.Orientation
	worksheet.PageSetUp.UsePrinterDefaults = s.ConfigPrinter.UsePrinterDefaults
